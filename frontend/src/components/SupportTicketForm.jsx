...
const SupportTicketForm = () => {
  ...
  return (
    // ✅ CHANGE 1: added overflow-hidden (was missing — caused content to be clipped)
    <div className="flex h-screen overflow-hidden bg-gray-50 font-poppins">
      <Navbar />

      {/* ✅ CHANGE 2: overflow-y-auto + items-start (was items-center — that clips top when content is tall) */}
      <div
        className="flex-1 overflow-y-auto flex items-start justify-center p-10"
